// 10_Flip Triangles
//    - keyboard input: R, G, B, P to change the color of traingle
...
bool verticalFlip = false; //처음에는 제대로
float colorR = 1.0f, colorG = 0.0f, colorB = 0.0f; //처음에는 Red
...
void key_callback(GLFWwindow *window, int key, int scancode, int action, int mods) {
    ...
    //&&조건이 안들어있으면 release 일때도 실행되기때문에 f키를 누를때1번, release할때1번 toggle됨
